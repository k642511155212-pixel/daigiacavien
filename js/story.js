(function () {
  ...
  const scenes = {
    intro:{ id:"intro", title:"300 nghìn cuối cùng", lines:[
      { name:"Thảo", avatar:"./assets/ui/cart.svg", text:"Công việc làm ăn xa nhà thất bại. Tôi quay về Biên Hòa với đúng 300.000đ và một chiếc xe cá viên cũ trong sân." },
      { name:"Thảo", avatar:"./assets/ui/cart.svg", text:"“Thôi thì còn bao nhiêu vốn bỏ vô cá viên hết vậy.” Nghe không giống kế hoạch kinh doanh lắm, nhưng ít nhất nó là một khởi đầu." },
    ...
    chapter3:{ id:"chapter3", title:"15 phút ra chơi", lines:[
      ...
      { name:"Thảo", avatar:"./assets/ui/cart.svg", text:"Mười lăm phút sau đó dài hơn cả một buổi bán bình thường." }
    ]},
    rival:{ id:"rival", title:"Quầy bên kia đường", lines:[
      ...
      { name:"Thảo", avatar:"./assets/ui/cart.svg", text:"Dạ." },
      { name:"Chị Hồng", avatar:avatar("chi-hong"), text:"...cho chị một phần cá viên coi thử. Chị đang nghiên cứu thị trường." },
      { name:"Thảo", avatar:"./assets/ui/cart.svg", text:"Cuộc cạnh tranh bắt đầu bằng một phần cá viên và kết thúc bằng việc chị ấy ghé ba ngày liên tục." }
    ]},
    foodRush:{ id:"foodRush", title:"Food Street Rush", lines:[
      ...
      { name:"Thảo", avatar:"./assets/ui/cart.svg", text:"Chơi luôn." },
    ...
    exams:{ id:"exam-scene", title:"Mùa thi", lines:[
      ...
      { name:"Cô Linh", avatar:avatar("co-linh"), text:"One test doesn't define you. Ăn trước, rồi mình xem từng lựa chọn." },
      { name:"Thảo", avatar:"./assets/ui/cart.svg", text:"Mùa thi làm đơn hàng ít đi một chút, nhưng câu chuyện ở quầy lại nhiều hơn." }
    ]},
    cooperation:{ id:"cooperation", title:"Hai quầy, một cơn đông", lines:[
      ...
      { name:"Thảo", avatar:"./assets/ui/cart.svg", text:"Không thi nữa hả chị?" },
    ...
    endless:{ id:"endless", title:"Biên Hòa không ngủ", lines:[
      ...
      { name:"Thảo", avatar:"./assets/ui/cart.svg", text:"Em cũng đâu có tính nhường." },
