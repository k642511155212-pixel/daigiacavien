...
assert.ok(G.Characters.all.length >= 29, "Fewer than 29 recurring characters");
...
assert.equal(defaults.saveVersion, 2, "Save schema version 2 is missing");
...
assert.equal(migrated.saveVersion, 2, "Old save was not migrated to schema 2");
...
G.UI = {
  byId: fakeElement, showScreen(){}, renderIngredients(){}, renderSauces(){}, renderFryers(){}, updateFryers(){}, renderTray(){}, renderCustomers(){}, updateCustomers(){},
